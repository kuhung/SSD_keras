...
def SSD300(input_shape, num_classes=21):
    ...
    net['conv8_2'] = Conv2D(256, kernel_size=(3,3), strides=(2, 2),
                                   activation='relu', padding='same',
    ...
    num_priors = 3
    x = Conv2D(num_priors * 4, kernel_size=(3,3), padding='same',
    ...
    x = Conv2D(num_priors * num_classes, kernel_size=(3,3), padding='same',
    ...
    # Prediction from fc7
    num_priors = 6
    net['fc7_mbox_loc'] = Conv2D(num_priors * 4, kernel_size=(3,3),
                                        padding='same',
    ...
    if num_classes != 21:
        name += '_{}'.format(num_classes)
    net['fc7_mbox_conf'] = Conv2D(num_priors * num_classes, kernel_size=(3,3),
                                         padding='same',
                                         name=name)(net['fc7'])
